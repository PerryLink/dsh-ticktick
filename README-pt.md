...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness **dsh-v0.1.7-alpha.2** (tag do GitHub). Linha npm fixada em `@deepseek-ai/dsh` **0.1.7-alpha.2** (peers `>=0.1.7-alpha.1 <0.2.0`). Verificado contra o checkout dsh-v0.1.7-alpha.2 (cadeia completa de gates + smoke de instalação de perfil). |
| Node | `^22.19.0 \|\| >=24.0.0` |
