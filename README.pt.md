...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness **dsh-v0.1.5-alpha.1** (tag do GitHub). Linha npm fixada em `@deepseek-ai/dsh` **0.1.2-rc.1** (peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`). Verificado em 2026-09-09 contra o checkout master dsh-v0.1.5-alpha.1 (cadeia completa de gates + smoke de instalação de perfil). |
