...
export const en = {
  ...
  tomorrow: 'tomorrow',
  warning: 'Warning',
  unconfigured: 'No TickTick token: set it in Plugins → TickTick.',
  ...
  settingsMcpUrlHint: 'Saved to the profile and applied live.',
  settingsProtected: 'Protected task ids',
  settingsProtectedHint: 'Comma-separated; mutating operations refuse these. Applied live.',
  settingsSave: 'Save',
  settingsSaved: 'Saved',
  settingsSummaryConfigured: 'API token configured — ready to connect.',
  settingsSummaryUnconfigured: 'Set your TickTick API token to enable tasks.',
  settingsTokenStored: 'API token (already stored — type to replace)',
  settingsUnavailable: 'This configuration is not available on the connected host.',
  settingsRejected: 'The host refused this change; a field is invalid or changed elsewhere.',
...
export const zh: TicktickLocale = {
  ...
  tomorrow: '明天',
  warning: '警告',
  unconfigured: '未配置滴答令牌：请在 插件 → TickTick 中设置。',
  loadError: '加载失败：',
  settingsName: 'TickTick',
  ...
  settingsMcpUrlHint: '写入 profile 并即时生效。',
  settingsProtected: '受保护任务 id',
  settingsProtectedHint: '逗号分隔；变更操作拒绝这些任务。即时生效。',
  settingsSave: '保存',
  settingsSaved: '已保存',
  settingsSummaryConfigured: 'API 口令已配置，可以连接。',
  settingsSummaryUnconfigured: '设置 TickTick API 口令以启用任务。',
  settingsTokenStored: 'API 口令（已保存——输入以替换）',
  settingsUnavailable: '当前连接的主机不提供此配置。',
  settingsRejected: '主机拒绝了这次修改；字段非法或已在别处被改动。',
  settingsTest: '测试连接',
  ...
  panelTokenSave: '保存令牌',
  panelTokenHint: '尚未配置令牌——在此粘贴，或前往 插件 → TickTick。',
  statusConnected: '已连接',
