...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness **dsh-v0.1.7-rc.2** (GitHub tag). npm dependency line: `@deepseek-ai/dsh` **0.1.7-rc.2** (peers `>=0.1.7-alpha.1 <0.2.0`). Verified against the dsh-v0.1.7-rc.2 checkout (full gate chain + profile install smoke). |
| Node | `^22.19.0 \|\| >=24.0.0` |
